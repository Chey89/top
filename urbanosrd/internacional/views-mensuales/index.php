<?php
function viewsmensuales_display_ranking() {
    $viewsmensuales_ranking_data = [];
    if (file_exists('/home/sabomdzv/billarrd.com/top/urbanosrd/internacional/updater/data/viewsmensuales_ranking_data.json')) {
        $viewsmensuales_ranking_data = json_decode(file_get_contents('/home/sabomdzv/billarrd.com/top/urbanosrd/internacional/updater/data/viewsmensuales_ranking_data.json'), true);
    }
    ...
    <main class="main-content">
        <div class="container">
            <h1 class="main-title">Entretenimiento Views Mensuales</h1>
            <div class="update-info">Actualizado: '.htmlspecialchars($ultima_actualizacion).'</div>
            
            <div class="ranking-grid">';

    if (!empty($viewsmensuales_ranking_data)) {
        foreach ($viewsmensuales_ranking_data as $index => $canal) {
                ...
                <div class="card-header">
                    ...
                    <div class="channel-main">
                        ...
                        <div class="stats-preview">
                            <span class="weekly-views">'.number_format($canal['visitas_mensuales']).'</span>
                ...
                <div class="card-details">
                    ...
                    <div class="extra-info hidden">
                        ...
                        <div class="channel-actions">
                            <a href="https://socialblade.com/youtube/channel/'.$canal['id'].'" 
...
viewsmensuales_display_ranking();
?>
