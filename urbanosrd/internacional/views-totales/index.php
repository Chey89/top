<?php
function viewstotales_display_ranking() {
    $viewstotales_ranking_data = [];
    if (file_exists('/home/sabomdzv/billarrd.com/top/urbanosrd/internacional/updater/data/viewstotales_ranking_data.json')) {
        $viewstotales_ranking_data = json_decode(file_get_contents('/home/sabomdzv/billarrd.com/top/urbanosrd/internacional/updater/data/viewstotales_ranking_data.json'), true);
    }
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu">
                        <div class="subdropdown">
                            ...
                            <div class="subdropdown-menu">
                                <a href="" class="nav-link"><p>Views Semanales</p></a>
                                <a href="" class="nav-link"><p>Views Mensuales</p></a>
                                <a href="" class="nav-link"><p>Views Totales</p></a>
                            </div>
                        </div>  
    ...
    <main class="main-content">
        <div class="container">
            <h1 class="main-title">Entretenimiento Views Totales</h1>
            <div class="update-info">Actualizado: '.htmlspecialchars($ultima_actualizacion).'</div>
            
            <div class="ranking-grid">';

    if (!empty($viewstotales_ranking_data)) {
        foreach ($viewstotales_ranking_data as $index => $canal) {
                ...
                <div class="card-header">
                    ...
                    <div class="channel-main">
                        ...
                        <div class="stats-preview">
                            <div class="weekly-views">' . number_format($canal['vistas_totales']) . '</div>
                ...
                <div class="card-details">
                    ...
                    <div class="extra-info hidden">
                        <div class="stats-grid">
                            <div class="stat-item">
                                <span>Views Semanales:</span>
                                <span>'.number_format($canal['visitas_semanales']).'</span>
                            </div>
                            <div class="stat-item"> <span>Views Mensuales</span> ' . number_format($canal['visitas_mensuales']) . '</div>                            
