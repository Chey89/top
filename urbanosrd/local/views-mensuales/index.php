...
function viewsmensuales_display_ranking() {
    ...
    if (file_exists('/home/sabomdzv/billarrd.com/top/urbanosrd/local/updater/data/viewsmensuales_ranking_data.json')) {
        $viewsmensuales_ranking_data = json_decode(file_get_contents('/home/sabomdzv/billarrd.com/top/urbanosrd/local/updater/data/viewsmensuales_ranking_data.json'), true);
    }
