...
function viewstotales_display_ranking() {
    ...
    if (file_exists('/home/sabomdzv/billarrd.com/top/entretenimiento/updater/data/viewstotales_ranking_data.json')) {
        $viewstotales_ranking_data = json_decode(file_get_contents('/home/sabomdzv/billarrd.com/top/entretenimiento/updater/data/viewstotales_ranking_data.json'), true);
    }
